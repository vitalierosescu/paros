...
export const addImgHoverEffect = () => {
  gsap.utils.toArray('.slider-projects_img-height').forEach((imgWrapper) => {
    ...
    if (img) {
      ...
      // imgWrapper.addEventListener('mouseover', () => imgWrapper.classList.toggle('cut-corners'));
      // imgWrapper.addEventListener('mouseout', () => imgWrapper.classList.toggle('cut-corners'));
